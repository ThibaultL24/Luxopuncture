      ...
      <SectionAtmosphere variant="soft" placement="both">
        <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:py-24">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            {items.map((p, i) => (
              <RevealOnScroll key={p.slug} variant={i % 3 === 0 ? 'fade-up' : i % 3 === 1 ? 'slide-right' : 'slide-left'}>
                <article className="group flex h-full flex-col overflow-hidden rounded-2xl border border-[var(--color-brand)]/10 bg-white shadow-sm transition hover:-translate-y-0.5 hover:shadow-[var(--shadow-soft)]">
                  {p.coverImage ? (
                    <div className="aspect-[16/10] overflow-hidden bg-[var(--color-surface-rose)]">
                      <img
                        src={p.coverImage}
                        alt=""
                    ...
                    <div className="flex aspect-[16/10] flex-col items-center justify-center gap-2 border-b border-[var(--color-brand)]/10 bg-[var(--color-surface-rose)] text-[var(--color-body)]/50">
