          ...
          <RevealOnScroll variant="slide-right" className="flex-1">
            <div>
              ...
              <div className="mt-10 flex flex-wrap gap-4">
                ...
                <Link
                  to="/programme"
                  className="inline-flex rounded-full border border-[var(--color-brand)]/25 bg-[var(--color-surface)] px-8 py-3.5 text-sm font-semibold text-[var(--color-ink)] shadow-sm backdrop-blur hover:border-[var(--color-brand)]/40 hover:bg-[var(--color-surface-rose)]"
                >
