...
export function CtaBanner() {
  return (
    <section className="mx-4 mb-20 overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-[var(--color-brand-mid)] via-[var(--color-brand)] to-[var(--color-brand-dark)] text-white sm:mx-6 lg:mx-auto lg:max-w-6xl">
