...
export const services: Service[] = [
  {
    ...
    detailGallery: [
      {
        src: "/images/programme_perte_de_poid.jpeg",
        alt: "Programme perte de poids — visuel 1",
      },
      {
        src: "/images/programme_perte_de_poid2.jpeg",
        alt: "Programme perte de poids — visuel 2",
      },
    ],
  },
  {
    ...
    intro: "Un protocole personnalisé, avec suivi des étapes clés du sevrage.",
    benefits: [
    ...
    detailGallery: [
      {
        src: "/images/programme_tabac.jpeg",
        alt: "Programme arrêt du tabac — visuel 1",
      },
      {
        src: "/images/programme_tabac2.jpeg",
        alt: "Programme arrêt du tabac — visuel 2",
      },
    ],
  },
  {
    ...
    detailGallery: [
      {
        src: "/images/programme_relaxation.jpeg",
        alt: "Programme relaxation — visuel 1",
      },
      {
        src: "/images/programme_relaxation2.jpeg",
        alt: "Programme relaxation — visuel 2",
      },
      {
        src: "/images/programme_relaxation3.jpeg",
        alt: "Programme relaxation — visuel 3",
      },
    ],
  },
  {
    ...
    detailGallery: [
      {
        src: "/images/programme_bien_être_ménopause.jpeg",
        alt: "Programme ménopause — visuel 1",
      },
      {
        src: "/images/programme_bien_être_ménopause2.jpeg",
        alt: "Programme ménopause — visuel 2",
      },
      {
        src: "/images/programme_bien_être_ménopause3.jpeg",
        alt: "Programme ménopause — visuel 3",
      },
    ],
  },
];
  ...
  cabinetRows: [
    {
      label: "Luxopuncture",
      price: "55 € la séance",
      note: "Les accompagnements se font généralement sous forme de programme, avec un nombre de séances adapté selon l’objectif (perte de poids, arrêt du tabac, relaxation, ménopause…).",
    },
...
export const aboutPractitioner = {
  ...
  bio: [
    ...
    "Au fil de mon parcours, j’ai ressenti le besoin d’aller encore plus loin dans ma pratique, pour mieux comprendre ce qui se joue derrière certaines difficultés. C’est ainsi qu'en 2024, l’hypnose est venue naturellement, dans un second temps.",
  ...
  credentials: [
    "Luxothérapeute depuis 2019 et hypnothérapeute depuis 2024",
    "Luxothérapie, hypnose, accompagnement arrêt du tabac et rééquilibrage alimentaire",
...
export const contactInfo = {
  ...
  address:
    "Cabinet à Avignon — accompagnements sur place ; programme détox à distance possible",
  hours:
    "Prise de rendez-vous uniquement par téléphone : lun–ven 9h–20h, sam 9h–18h",
} as const;

export const socialLinks = {
  facebook: "https://www.facebook.com/share/1EFxjFLqUv/",
  instagram:
    "https://www.instagram.com/laplace.luxopuncture?igsh=eGs0aDk4dHZsNDFr",
...
export const homeCopy = {
  ...
  remoteBrief: {
    ...
    footnote:
      "Sans détailler davantage ici — tout le détail est sur la page « À distance ».",
  },
  cabinetTeaser: {
...
export const cabinetServiceTeasers: readonly {
  ...
  },
  {
    ...
    title: "Relaxation & gestion du stress",
    description:
      "Apaiser les tensions, retrouver un état de calme et améliorer la qualité du sommeil.",
  },
  {
    slug: "menopause",
...
export const detoxProgramCopy = {
  ...
  introLead:
    "Vous avez l’impression de faire attention… mais votre corps ne suit plus ?",
  introSymptoms: "Ballonnements, fatigue, envies de sucre…",
  introQuestion:
    "Et si votre corps avait simplement besoin d’être rééquilibré ?",
  ...
  distanceSection: {
    ...
    highlight:
      "Je vous guide pas à pas, en m’adaptant à votre rythme et à votre fonctionnement.",
  },
  benefits: {
  ...
  howItWorks: {
    ...
    highlight1:
      "Vous êtes suivie à chaque étape, avec un accompagnement qui s’adapte à vous.",
    highlight2:
  ...
  approach: {
    title: "Mon approche",
    intro:
      "Je ne travaille ni dans la restriction, ni dans la culpabilisation.",
  ...
  modalities: {
    title: "Modalités",
    intro:
      "Le programme se déroule sur 3 semaines avec un accompagnement personnalisé comprenant :",
    items: [
      "1 bilan initial en visio",
      "4 séances de suivi",
      "un accompagnement tout au long du programme",
    ],
...
export const cabinetLuxoHypnoCopy = {
  ...
  contraList: [
    ...
    "grossesse",
    "traitement pour une maladie grave",
  ],
